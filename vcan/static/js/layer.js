		...
		filters: 		{
			...
			grayscale:			function(amount){
				...
				if(typeof polyfilter._ie === 'undefined'){
					...
					// Firefox
					// https://dvcs.w3.org/hg/FXTF/raw-file/tip/filters/index.jinja2
...
var ModalEffects = (function() {
	...
	function init() {
		...
		// var video_n=document.getElementById("marquee1_1").getElementsByTagName('li').length;
